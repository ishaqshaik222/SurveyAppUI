...
export const GetOnCallReportDetails = ({ google }: Props) => {
  ...
  const getOnCallReportDetailsWorker = async () => {
    try {
      ...
      const res = await fetch(`${BASE_URL}/getOnCallReports_p.php`, {
        method: "POST",
        headers: {
      ...
      debugger
      setReportDetailsWorkerData(json.response.ON_CALLS);
      debugger
